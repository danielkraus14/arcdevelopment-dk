    ...
    return ( 
        ...
        <       link rel='canonical' key='canonical' href='https://arc.com/revolution' />
            ...
            <Grid item container direction={matchesMD ? 'column' : "row"}  className={classes.rowContainer} alignItems='center' style={{marginTop: '5em'}}>
                <Grid item lg>
                    <img src='/assets/vision.svg' alt='mountain trough binoculars' style={{maxWidth: matchesSM ? '300px' : '40em', marginRight: matchesMD ? 0 : '5em'}}/>
                </Grid>
                <Grid item container direction='column' lg style={{maxWidth: '40em', marginTop: matchesMD ? '5em' : undefined}}>
                    <Grid item> 
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#B3B3B3', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined}>
                    ...
                    <Grid item style={{maxWidth: '20em'}}>
                        <Typography variant='body1' paragraph style={{color: '#fff'}} align={matchesMD ? 'center' : undefined}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#FF7373', height: '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined}>
                    ...
                    <Grid item style={{maxWidth: '20em'}}>
                        ...
                        <Typography variant='body1' paragraph style={{color: '#fff'}} align={matchesMD ? 'center' : undefined}>
                            Then it’s time for us to start on your minimum viable product. That’s just a fancy term for a mockup, which doesn’t include colors, imgs, or any other    polished design elements, but captures the essential layout structure and functionality.
                        </Typography>
                        <Typography variant='body1' paragraph style={{color: '#fff'}} align={matchesMD ? 'center' : undefined}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src='/assets/mockupIcon.svg' alt='basic website design outline' style={{maxWidth: 1000}} width='100%'/>
                </Grid>
            </Grid>
            {/*ITEM SECTION Review --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#39B54A', height: '90em'}}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src='/assets/reviewIcon.svg' alt='magnifying glass' style={{maxWidth: '40em'}} width='100%' />
                </Grid>
            </Grid>
            {/*ITEM SECTION Design --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#A67C52', height: '90em'}}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src='/assets/designIcon.svg' alt='paintbrush leaving stroke of paint' style={{maxWidth: 1000}} width='100%' />
                </Grid>
            </Grid>
            {/*ITEM SECTION Review --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#39B54A', height: '90em'}}>
            ...
            {/*ITEM SECTION Build --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#FBB03B', height: matchesMD ? '110em' : '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined}>
                    <Grid item>
                        <Typography variant='h4' gutterBottom style={{color: '#000', marginTop: '5em'}} align={matchesMD ? 'center' : undefined}>
                            Build
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src='/assets/buildIcon.svg' alt='building construction site' style={{maxWidth: matchesMD ? 600 : 1000}} width='100%' />
                </Grid>
            </Grid>
            {/*ITEM SECTION Launch --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#C1272D', height: matchesMD ? '110em' : '90em'}}>
                <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined}>
                    <Grid item>
                        <Typography variant='h4' gutterBottom style={{color: '#000', marginTop: '5em'}} align={matchesMD ? 'center' : undefined}>
                            Launch
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src='/assets/launchIcon.svg' alt='rocket' style={{maxWidth: 300}} width='100%'/>
                </Grid>
            </Grid>
            {/*ITEM SECTION Maintain --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#8E45CE', height: '90em'}}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src='/assets/maintainIcon.svg' alt='wrench tightening bolts' style={{maxWidth: 500}} width='100%'/>
                </Grid>
            </Grid>
            {/*ITEM SECTION Iterate --> */}
