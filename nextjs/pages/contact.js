      ...
      >
        <Grid item>
          <Grid item container direction="column">
            ...
            >
              <Grid item>
                <img alt="phone" src='/assets/phone.svg' className={classes.icon} />
              </Grid>
              <Grid item>
                <Typography
                  variant="body1"
            ...
            >
              <Grid item>
                <img alt="email" src='/assets/email.svg' className={classes.icon} />
              </Grid>
              <Grid item>
                <Typography
                  variant="body1"
            ...
            <Grid item container justify="center">
              ...
              >
                Send Message
                <img alt="airplane" src='/assets/send.svg' style={{ marginLeft: 10 }} />
              </Button>
            </Grid>
          </Grid>
        </Grid>
