...
let mailOptions = {
  from: "testformaterialui@gmail.com",
};
...
exports.sendMail = functions.https.onRequest((request, response) => {
  ...
  cors(request, response, () => {
    const {name, email, phone, message, total, service, plataforms, features, customFeatures, users, category} = request.query;

    if (total){
      if(category){
        mailOptions = {
          from: "Arc Development",
          to: "testformaterialui@gmail.com",
        ...
        mailOptions = {
          ...
          html: `
                  ...
                  <p style="font-size: 16px"> Total:${total}</p>
                  <p style="font-size: 16px"> Service:${service}</p>
                  <p style="font-size: 16px"> Platforms:${plataforms}</p>
