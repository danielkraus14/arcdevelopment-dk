    ...
    return ( 
        <Grid container direction='column'>
            ...
            {sections.map(section => (
                <Grid key={section.title} item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: section.backgroundColor, height: matchesMD ? '110em' : '90em'}}>
                    <Grid item container direction='column' lg alignItems={matchesMD ? 'center' : undefined}>
                        ...
                        <Grid item style={{maxWidth: '20em'}}>
                            {section.paragraphs.map(text => (
                                <Typography key={section.text} variant='body1' paragraph style={{color: '#fff'}} align={matchesMD ? 'center' : undefined}>
                                    {text}
                                </Typography>
                            ))}
                        </Grid>
