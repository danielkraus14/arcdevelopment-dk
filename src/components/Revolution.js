    ...
    return ( 
        <Grid container direction='column'>
            ...
            <Grid item container direction={matchesMD ? 'column' : "row"}  className={classes.rowContainer} alignItems='center' style={{marginTop: '5em'}}>
                <Grid item lg>
                    <img src={vision} alt='mountain trough binoculars' style={{maxWidth: matchesSM ? '300px' : '40em', marginRight: matchesMD ? 0 : '5em'}}/>
                </Grid>
            ...
            {/*SECTION Technology --> */}
            <Grid item container direction="row" direction={matchesMD ? 'column' : "row"} className={classes.rowContainer} alignItems='center' style={{marginTop: '10em', marginBottom: '10em'}}>
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#39B54A', height: '90em'}}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src={review} alt='magnifying glass' style={{maxWidth: matchesMD ? 600 : 1000}} width='100%' />
                </Grid>
            </Grid>
            {/*ITEM SECTION Design --> */}
            ...
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#FBB03B', height: matchesMD ? '110em' : '90em'}}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src={build} alt='building construction site' style={{maxWidth: matchesMD ? 600 : 1000}} width='100%' />
                </Grid>
            </Grid>
            {/*ITEM SECTION Launch --> */}
            <Grid item container direction={matchesMD ? 'column' : 'row'} className={classes.rowContainer} style={{backgroundColor: '#C1272D', height: matchesMD ? '110em' : '90em'}}>
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img src={launch} alt='rocket' style={{maxWidth: 300}} width='100%'/>
                </Grid>
            </Grid>
